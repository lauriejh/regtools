...
<!-- Mention what type of files are supported, and refere to the parquet vignette for more information about it. It is recommended for performance, that large datasets stored as parquet files and then read/filtered -->
...
<!-- Mention again that parquet files are going to be more efficient when filtering data -->
...
<!-- Include that also supports ICP-2 codes in the case of primary care data  -->
...
<!-- Give concrete example of curate diag -->
...
For example, to only keep observations where the individuals have resided in the municipality "1146" between the years 2012-2015: 

<!-- Need to change example, there are no observations with those codes  -->
