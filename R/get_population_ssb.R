...
#'
#' @param url_api URL used for the SSB API call. Do not modify.
#' @param regions Supported regions: "norway" for the country-wise population counts, "fylker" for county population counts, "kommuner" for municipality population counts. Due to region reforms in Norway, the results are shown using SSB's harmonized county codes.
#' @param years Numerical or character vector containing year or years
#' @param ages Desired ages in whole years
#' @param aggregate_age If TRUE and more than one age given, new row with aggregated population for age group
#' @param by_sex Should population results be disaggregated by sex
#' @param save_xslx Want to save the results as a xslx in your current working directory
